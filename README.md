...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Adam_El_Fennych-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/adaelfennych)
...
-   📚 **Learning:** Object-Oriented Programming (OOP) & System Design
...
| :--- | :--- | :--- |
| [**NexusBank&nbsp;CLI**](https://github.com/Valkenan/NexusBank-CLI) | **Core Banking System:** Robust financial management engine featuring a custom file-based database, transaction validation, and atomic operations. | `C++` |
| [**Athens&nbsp;Explorer**](https://github.com/Valkenan/Athens-Explorer-Web) | **Modern Web Portal:** Accessible tourism landing page featuring semantic HTML architecture and next-gen OKLCH color spaces. | `HTML` `CSS` |
